...
less $VCF|head -n 1500| grep '^#C' | tail -n 1 > $curpath/annotated/${OUTFILE}.avinput.header # Extract all VCF header lines.  Last line of VCF header contains column names.  Write last line of VCF header to .avinput.header file
